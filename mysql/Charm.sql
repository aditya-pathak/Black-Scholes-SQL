CREATE FUNCTION BS.Charm(@_CallPut int, @_s0 decimal(8,2), @_q decimal(8,2), @_t decimal(8,2), @_X decimal(8,2), @_r decimal(8,2), @_s decimal(8,2)) 
RETURNS decimal(8,2)
BEGIN
	Declare @_d1 decimal(8,2)
	Declare @_dd1 decimal(8,2)
	Declare @_d2 decimal(8,2)
